...
public class Activity13_2a {
    public void writeExcel(String filePath) throws IOException {
        ...
        String[] row1 = {"1", "Kiran", "Shah", "kirshah@example.com", "4537829158"};
        String[] row2 = {"2", "Avinash", "Kati", "avinashK@example.com", "4892184058"};
        String[] row3 = {"3", "Hari", "Rai", "Hari.rai@example.com", "4528727830"};
    ...
    public static void main(String args[]) throws IOException {
        String filePath = "C:\\Users\\0021ZY744\\IdeaProjects\\FST_Selenium\\src\\test\\java\\sample.xlsx";
